...
def main():
	...
	parser.add_option("--lmask",    type="float",   default= 280,               help="length of mask to apply along helix in Angstroms (default=280)")
	parser.add_option("--ilmask",   type="float",   default= 0,                help="radius of inner mask to apply along helix in Angstroms (default=0)")
	...
	parser.add_option("--hsearch",  type="string",  default= "0.0 50.0",      help="inner & outer radii for helical search (in Angstroms, default=0.0 50.0)")
	...
	parser.add_option("--olmask",       type= "float",   default= 15,	help="radius of outer mask to apply along helix in pixels (default = 15)")
        ...
        if len(args) < 3 or len(args) > 4:
			...
			options.wcmask, options.debug, options.recon_pad, options.MPI, options.olmask)
